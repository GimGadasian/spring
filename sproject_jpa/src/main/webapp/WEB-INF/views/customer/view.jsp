						...
						<div class="bRight">
							<ul>
							    <c:if test="${session_id != null}">
							        <li><a href="/customer/reply?bno=${board.bno}" class="sbtnMini mw">답변 달기</a></li>
							        <c:if test="${session_id == board.member.id}">
							            <li><a onclick="deleteBtn()" class="sbtnMini mw">수정</a></li>
							            <li><a href="#" class="sbtnMini mw" onclick="return deleteBtn();">삭제</a></li>
							        </c:if>
							    </c:if>
